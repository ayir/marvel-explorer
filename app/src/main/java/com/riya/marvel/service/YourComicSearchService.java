...
public class YourComicSearchService extends IntentService {

    private final String LOG_TAG = YourComicSearchService.class.getSimpleName();
    public static final String SEARCH_PARAM = "param";

    private  Uri builtUri;
    public YourComicSearchService() {
        super("YourHeroes");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String order = "title"; // name, modified, -name, -modified (- is descending order)

        try {

            final String COMIC_BASE_URL = "http://gateway.marvel.com/v1/public/comics";
            final String QUERY_PARAM = "titleStartsWith";
